...
/**
 * struct passinfo - contains pseudo-arguements to pass into the
 * function as an arguments.
 * allowing uniform prototype for the function of
 * pointer struct present in the codes.
 * @arg: This is a string generated from
 * a getline containing arguements in the codes present.
 * @argv: This is an array of strings
 * into the generated from arg
 * @path: This is the string path for the current command
 * @argc: This is the argument counted
 * @line_count: this is the error counted
 ...
 * @env_changed: this is ckecks on if environ was changed
 * @status: this will return the return status of the last exec'd command
...
/**
 * struct builtin - contains a builtin that string and
 * related function which will be display
 * @type: the builtin command flag
 * @func: this is the function to be passed.
 */
